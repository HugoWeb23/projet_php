...
$req = $bdd->prepare('UPDATE personnel SET nom = :nom, prenom = :prenom, email = :email, date_naissance = :date_naissance, tel_fixe = :tel_fixe, gsm = :gsm, id_adresse = :id_adresse WHERE id_personnel = :id');    
...
break;
case 4:
$message = array("type" => "succes", "message" => "Le compte employé a été mis à jour");
break;
case 3:
