...
<?php 
$req = $bdd->prepare('SELECT COUNT(b.id) as compteur, a.id_produit as id_produit, libelle, prix, photo FROM produits as a LEFT JOIN produits_categories as b ON a.id_produit = b.id_produit GROUP BY a.id_produit, libelle, prix, photo');
$req->execute();
